...
<main class="form-signin">
  <form action="/add" method="POST">
    ...
    <div class="form-floating">
      <input type="nama" class="form-control" id="floatingInput" placeholder="name@example.com" name="name" required>
    ...
    <button class="w-100 btn btn-lg mb-3" style="background-color: #082032; color: white;" type="submit">Register</button>
    <p>Sudah punya akun? <a href="/login" style="color: #082032;">Login di sini</a></p>
